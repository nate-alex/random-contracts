...
contract morkV0 is ERC721Full {
    ...
    constructor() ERC721Full("morkV0.1", "(◕-◕)" public {
...
//       require(block.timestamp < 1574711999, "ChainFaces sale has completed. They are now only available on the secondary market. ");
        ...
        string[1] memory header = [ '<svg width="640" height="480">' ];
        string[1] memory leftFaceCharacters = [ '<path d="m142.5104,89.52431c-51,0 -81,2 -81.5104,1.47569c-0.5104,-0.52431 -0.4896,218.52431 -1,218c-0.5104,-0.52431 86.5104,7.52431 86,7c-0.5104,-0.52431 0.5104,-28.47569 -3.4896,-28.47569c-4,0 -68,-1 -68.5104,-1.52431c-0.5104,-0.52431 5.5104,-167.47569 5,-168c-0.5104,-0.52431 78.5104,-2.47569 78,-3c-0.5104,-0.52431 -3.4896,-26.47569 -4,-27c-0.5104,-0.52431 -10.4896,1.52431 -10.4896,1.52431z" fill="#ab3" id="svg_1" stroke="#000000" stroke-width="4"/>' ];
        string[1] memory leftEyeCharacters = ['<path d="m186.5104,141.52431l31.4896,-64.52431l43,60l-11,4l-31,-42l-23,50l-9.4896,-7.47569z" fill="#333333" id="svg_3" stroke="#000000" stroke-width="4"/>'];
        string[1] memory mouthCharacters = ['<path d="m292.5104,227.52431c0,0 -11,9 -11,10c0,1 -3,16 -3.5104,15.47569c-0.5104,-0.52431 12.5104,10.52431 15.5104,10.52431c3,0 19,-7 18.4896,-7.52431c-0.5104,-0.52431 0.5104,-18.47569 0,-19c-0.5104,-0.52431 -19.4896,-9.47569 -19.4896,-9.47569z" fill="#123456" id="svg_5" stroke="#000000" stroke-width="4"/>' ];
        string[1] memory rightEyeCharacters = ['<path d="m336.5104,89.52431l1.4896,15.47569c0,0 2.5104,12.52431 3.5104,12.52431c1,0 15,4 14.4896,3.47569c-0.5104,-0.52431 14.5104,-0.47569 14,-1c-0.5104,-0.52431 11.5104,-5.47569 11,-6c-0.5104,-0.52431 9.5104,-9.47569 9,-10c-0.5104,-0.52431 1.5104,-13.47569 1,-14c-0.5104,-0.52431 -13.4896,-4.47569 -14,-5c-0.5104,-0.52431 0.5104,14.52431 0.5104,15.52431c0,1 -6,8 -8,8c-2,0 -15,1 -15,1c0,0 -6,-20 -6.5104,-20.52431c-0.5104,-0.52431 -11.4896,0.52431 -11.4896,0.52431z" fill="#5a145b" id="svg_6" stroke="#000000" stroke-width="4"/>'];
        string[1] memory rightFaceCharacters = ['<path d="m441.5104,76.52431c1,0 31,5 30.4896,4.47569c-0.5104,-0.52431 13.5104,15.52431 13,15c-0.5104,-0.52431 19.5104,25.52431 19,25c-0.5104,-0.52431 -5.4896,17.52431 -6.4896,19.52431c-1,2 -8,35 -11,39c-3,4 -10,20 -10.5104,19.47569c-0.5104,-0.52431 29.5104,8.52431 29,8c-0.5104,-0.52431 -30.4896,15.52431 -31,15c-0.5104,-0.52431 9.5104,19.52431 9,19c-0.5104,-0.52431 7.5104,13.52431 8.5104,17.52431c1,4 1,32 -1,33c-2,1 -10,16 -12,19c-2,3 -25,17 -28,18c-3,1 -18,1 -18.5104,0.47569c-0.5104,-0.52431 12.5104,-10.47569 12.5104,-10.47569c0,0 26,-19 26,-19c0,0 2,-29 2,-33c0,-4 -8,-18 -8.5104,-18.52431c-0.5104,-0.52431 -9.4896,-21.47569 -10,-22c-0.5104,-0.52431 13.5104,-15.47569 13,-16c-0.5104,-0.52431 -8.4896,-18.47569 -9,-19c-0.5104,-0.52431 15.5104,-18.47569 15.5104,-18.47569c0,0 8,-30 7.4896,-30.52431c-0.5104,-0.52431 3.5104,-20.47569 3.5104,-20.47569c0,0 -16,-21 -16.5104,-21.52431c-0.5104,-0.52431 -24.4896,-12.47569 -25,-13c-0.5104,-0.52431 -19.4896,-10.47569 -20,-11c-0.5104,-0.52431 18.5104,0.52431 18.5104,0.52431z" fill="#777777" id="svg_8" stroke="#000000" stroke-width="4"/>' ];
		
		uint256 headerID = 0;
        uint256 leftFacePartID = 0;
        uint256 leftEyePartID = 0;
        uint256 mouthPartID = 0;
        uint256 rightEyePartID = 0;
        uint256 rightFacePartID = 0;
        
        string memory faceAssembly = string(abi.encodePacked(header[headerID], leftFaceCharacters[leftFacePartID], leftEyeCharacters[leftEyePartID], mouthCharacters[mouthPartID], rightEyeCharacters[rightEyePartID], rightFaceCharacters[rightFacePartID], "</svg>"));
