...
contract GiantSwanNFT is ERC721Full, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721Full("Giant Swan", "SWAN") public {
        fileIPFSReferenceURL = "https://gateway.pinata.cloud/ipfs/";
        fileArweaveReferenceURL = "https://arweave.rocks/";
        tokenReferenceURI = "https://GiantSwanNFT.azurewebsites.net/api/HttpTrigger?id=";
    }
    ...
    function getImageLink(uint256 tokenID) public view returns (string memory fileIPFSURL, string memory fileArweaveURL, string memory thumbnailURL) {
        ...
        thumbnailURL = string(abi.encodePacked(fileIPFSReferenceURL, thumbnailHashStorage[tokenID]));
    }
    ...
    function createArt(string memory fileIPFSHash, string memory fileArweaveHash, string memory thumbnailHash, string memory artistName, string memory artTitle, string memory artistNote, string memory exhibition, uint256 royaltyFee, uint256 totalCap, string memory fileType) public onlyOwner {
